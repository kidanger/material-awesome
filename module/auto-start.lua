...
--awful.spawn.single_instance('compton --config ' .. filesystem.get_configuration_dir() .. '/conf/compton.conf --backend xrender --vsync drm --unredir-if-possible --xrender-sync-fence')
--awful.spawn.single_instance('gebaard')
